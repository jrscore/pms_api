...
class MonitRepository {
    ...
    save(mnt) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const newdoc = yield monit_model_1.monitModel.create(mnt);
            }
            catch (error) {
    ...
    getByCorp(corp) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const monit_arr = yield monit_model_1.monitModel.find({ corp: corp }).sort({ _id: -1 });
                if (monit_arr) {
                    return monit_arr;
                }
                else {
    ...
    getDay(date) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const json = yield monit_model_1.monitModel.findOne({
                    date: {
                        $gte: start,
                        $lte: end
                    }
...
//# sourceMappingURL=%08monit_repository.js.map