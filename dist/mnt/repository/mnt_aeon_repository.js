...
exports.AeonMonitRepository = void 0;
const mongoose_model_1 = require("./mongoose_model");
class AeonMonitRepository {
    // 현재 데이터를 받아서 저장한다
    addlogs(monit) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const newdoc = yield mongoose_model_1.aeonModel.create(monit);
                return newdoc;
            }
            catch (error) {
    ...
    getCurrent() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const json = yield mongoose_model_1.aeonModel.findOne().sort({ _id: -1 }).exec();
                if (json) {
                    return json;
                }
                else {
    ...
    getDay(date) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const json = yield mongoose_model_1.aeonModel.findOne({
                    date: {
                        $gte: start,
                        $lte: end
                    }
...
exports.AeonMonitRepository = AeonMonitRepository;
